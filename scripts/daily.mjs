...
function specializeLens(repo, lens) {
  const overrides = {
    ...
    "ruvnet/RuView": {
      editorialMethod: "manual-deep-update-2026-09-14",
      primaryLang: "TypeScript/Python AI review workspace",
      domain: "AI 评审与视频理解工作台 / 多模态内容审阅 Agent",
      userPain: "团队审阅视频、长文档或多模态素材时，人工需要反复定位片段、提炼问题和输出结构化评审；单次聊天很难保留时间线、证据引用、修改建议和多人协作状态。",
      coreMechanism: "RuView 把多模态输入、AI 分析、评审面板、结构化反馈和可追踪修改建议放到同一工作台，让 Agent 辅助定位内容问题并组织成可复核 review 流。",
      safeEntry: "先用内部低敏视频或产品演示做 20 条评审回放：要求每条建议带时间点、证据和人工确认状态，不直接对外发布自动生成的质量结论。",
      businessValue: "适合内容运营、教育、产品研究和多模态数据团队评估 AI-assisted review 流程，减少粗看素材和整理反馈的机械时间。",
      successMetric: "问题定位准确率、时间点引用准确率、人工采纳率、漏检率、误报率、评审完成时长、多人协作冲突、导出格式可用性和隐私违规样本",
      inspectFirst: "先看支持的媒体格式、模型调用路径、时间线/标注 schema、数据存储、权限与分享、导出格式、离线能力、license 和 issue 中的多媒体失败反馈。",
      bestFit: "有人工终审、素材低敏且需要结构化反馈沉淀的内容、产品、教育和研究团队。",
      badFit: "自动内容审核唯一依据、涉未成年人/隐私视频、合规判定、无人工复核，或要求强实时处理的生产审核链路。",
      primaryRisk: "多模态评审 Agent 容易把片段误解包装成确定结论；必须保留时间点证据、人工确认和敏感素材处理边界。",
    },
    "vxcontrol/pentagi": {
      editorialMethod: "manual-deep-update-2026-09-14",
